...
const MyComponent = () => {
  ...
  useEffect(() => {
    ...
    if (document.getElementById("area-chart") && typeof ApexCharts !== 'undefined') {
      const chart = new ApexCharts(areaChartRef.current!, options);
      chart.render();
    }
  }, []);
  ...
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
      ...
      <div id="area-chart" ref={areaChartRef}>
        <ApexCharts options={options} series={options.series} type="area" width={100} />
      </div>
